...
const frequencyPeriod = Number(process.env.NEXT_PUBLIC_EXOCLICK_MOBILE_POPUNDER_FREQUENCY_PERIOD || "5");
const frequencyCount = Number(process.env.NEXT_PUBLIC_EXOCLICK_MOBILE_POPUNDER_FREQUENCY_COUNT || "2");
const triggerDelay = Number(process.env.NEXT_PUBLIC_EXOCLICK_MOBILE_POPUNDER_TRIGGER_DELAY || "60");
